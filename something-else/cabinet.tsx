        ...
        <section className="flex flex-col gap-28">
          <div className="grid grid-rows-2 md:grid-rows-1 md:grid-cols-2 gap-8 lg:gap-16">
            <div className="p-2 flex flex-col gap-8 self-center">
              ...
              <p className="text-sm text-slate-500">
                Nous voulons que vous vous sentiez bien dans votre bien-être
                bucco-dentaire. Pas seulement deux fois par an, mais chaque fois
                que vous prenez une bouchée, racontez une blague ou riez.
              </p>
            ...
            <div className="flex gap-6 justify-center">
              <Image
                ...
                height={500}
                alt="majd"
                className="rounded-2xl h-5/6 max-w-[70%] object-contain place-self-start"
              />
              <Image
                src={cabinet2}
                width={390}
                height={500}
                alt="majd"
                className="rounded-2xl h-5/6 max-w-[50%] object-cover place-self-end"
              />
            </div>
          </div>
          ...
          <div className="p-2 flex flex-col gap-8 self-center">
            ...
            <div className="grid grid-cols-8">
              <h2 className="text-4xl col-span-4">
                Apprenez à connaître notre équipe
              </h2>
            ...
            <div className="grid grid-rows-1 grid-cols-4 text-center text-sm gap-8">
              ...
              {docs.map((doc, index) => (
                ...
                >
                  <div
                    className={`flex rounded-2xl justify-center h-full bg-${doc.color}`}
                  >
                    <Image
                      src={doc.img}
                      width={290}
                      height={402}
                      alt="majd"
                      className="p-4 pb-0 object-cover"
                    />
                  </div>
